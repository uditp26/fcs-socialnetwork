    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('public_posts', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=500), size=None)),
                ('frnd_timestamp', django.contrib.postgres.fields.ArrayField(base_field=models.DateTimeField(), size=None)),
                ('pblc_timestamp', django.contrib.postgres.fields.ArrayField(base_field=models.DateTimeField(), size=None)),
            ],
        ),
        migrations.CreateModel(
            name='Request',
